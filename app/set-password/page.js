    ...
    <div style={{ minHeight: "100vh", background: "#0d1117", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      ...
      <div style={{ width: "100%", maxWidth: "420px", background: "#161b22", border: "1px solid #21262d", borderRadius: "16px", padding: "36px" }}>
        ...
        <button
          ...
          style={{ width: "100%", marginTop: "20px", padding: "13px", background: loading || password.length < 6 ? "#1f2937" : "#22c55e", color: loading || password.length < 6 ? "#6b7280" : "#0d1117", border: "none", borderRadius: "10px", fontWeight: "700", fontSize: "15px", cursor: loading || password.length < 6 ? "not-allowed" : "pointer" }}
        >
